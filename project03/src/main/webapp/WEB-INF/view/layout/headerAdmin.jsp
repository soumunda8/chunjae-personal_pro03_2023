    ...
    <div class="columns">
        <div class="column is-3 ">
            <aside class="menu is-hidden-mobile">
                ...
                <ul class="menu-list">
                    <li><a href="${path }/memberList.do" <c:if test="${adminNum == 0 }">class="is-active"</c:if>>회원 관리</a></li>
                    <li><a href="#" <c:if test="${adminNum == 1 }">class="is-active"</c:if>>공지사항 관리</a></li>
                    ...
                    <li><a href="#" <c:if test="${adminNum == 4 }">class="is-active"</c:if>>투표 관리</a></li>
                </ul>
            </aside>
        </div>
