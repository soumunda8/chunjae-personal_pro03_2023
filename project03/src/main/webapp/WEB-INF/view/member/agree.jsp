...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다.
                            ...
                            <label for="ckItem1" class="checkbox"><input type="checkbox" id="ckItem1">약관에 동의</label>
                        </div>
                        <div class="field">
                            <article class="agree_fr">
제1장 총칙
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
                            ...
                            <label for="ckItem2" class="checkbox"><input type="checkbox" id="ckItem2">개인정보처리방침에 동의</label>
                        </div>
                        <div class="buttons is-centered">
                            <label for="allItem" class="checkbox"><input type="checkbox" id="allItem">전체 동의</label>
                        </div>
                        <div class="buttons is-centered">
                            <button class="button is-mainColor" id="nextStep">다음</button>
                        </div>
                    </div>
                    <script>
                        $("#allItem").on("click", function (){
                            var allItem = $("#allItem").is(":checked");
                            var ckItem1 = $("#ckItem1");
                            var ckItem2 = $("#ckItem2");
                            if(allItem) {
                                ckItem1.prop('checked',true);
                                ckItem2.prop('checked',true);
                            } else {
                                ckItem1.prop('checked',false);
                                ckItem2.prop('checked',false);
                            }
                        });

                        $("#nextStep").on("click", function () {
                            var ckItem1 = $("#ckItem1").is(":checked");
                            var ckItem2 = $("#ckItem2").is(":checked");
